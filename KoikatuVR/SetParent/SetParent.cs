...
//			female = HSceneInterpreter.lstFemale[0];
//			obj_chaF_001 = female.objRoot;
//			playerBodybone = male.objAnim;
//			charaBodybone = female.objAnim;
...
//				if (playerBodybone != null && SetParentMale.Value && currentCtrlstate != CtrlState.Following)
//				{
//					/////////////////////////
...
//					/////////////////////////
//					var cameraVec = cameraEye.transform.position - maleCrotchPos.transform.position;
//					var maleSpineVec = maleHeadPos.transform.position - maleCrotchPos.transform.position;
//					Quaternion.FromToRotation(maleSpineVec, cameraVec).ToAngleAxis(out float lookRotAngle, out Vector3 lookRotAxis);
//					playerBodybone.transform.RotateAround(maleCrotchPos.transform.position, lookRotAxis, lookRotAngle);
...
//			var boxCollider2 = shoulderCollider.AddComponent<BoxCollider>();
...
//				else
//				{
//					var meshCollider = mapObjCollider.AddComponent<MeshCollider>();
...
//		{
//			var maleNeck = maleFBBIK.references.spine[2].gameObject;
//			if (maleHeadPos == null)
...
//			maleCrotchPos.transform.parent = playerBodybone.transform;
//		}
...
//				foreach (var pos in vecSpinePos)
//				{
//					sum += pos;
//				}
//				sum /= 20f;
//				charaBodybone.transform.position += sum - femaleBase.transform.position;
//			}
//			else
//			{
...
//			///////////////////
//			var nonParentSide = ParentSideEnum(oppositeSide: true);
...
//					playerBodybone.transform.parent = male.objTop.transform;
//					break;
...
//						UnityEngine.Object.Destroy(obj_chaF_001.GetComponent<AnimSpeedController>());
//					}
//					playerBodybone.transform.parent = charaBodybone.transform;
...
//		internal GameObject charaBodybone;
...
//		internal GameObject playerBodybone;
