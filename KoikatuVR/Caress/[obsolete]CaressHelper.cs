...
//            _maleEyes = male.objHeadBone.transform.Find("cf_J_N_FaceRoot/cf_J_FaceRoot/cf_J_FaceBase/cf_J_FaceUp_ty/cf_J_FaceUp_tz");
...
//            //if (_sensibleH)
//            //{
//                StartCoroutine(LickCoEx(colliderKind));
...
//            while (!GameCursor.isLock || handCtrl.GetUseAreaItemActive() == -1)
//            {
//                if (timer < Time.time)
//                {
//                    Halt();
...
//        {
//            var tool = _device.GetComponent<SchoolTool>();
//            if (tool == null || !tool.IsGrab)
//            {
//                tool = _device1.GetComponent<SchoolTool>();
//            }
//            tool.DestroyGrab();
//        }
//        /// <summary>
...
//            DestroyGrab();
//            while (HSceneInterpreter.IsTouch || handCtrl.useItems[2] == null)
//            {
...
//            var tongue = handCtrl.useItems[2].obj.transform.Find("cf_j_tangroot");
//            var rotOffset = Quaternion.Inverse(tongue.rotation) * head.rotation;
//            //_latestPoi = handCtrl.useItems[2].obj.transform.parent;

//            var tonguePosOffset = new Vector3(0f, dic.itemOffsetUp, dic.itemOffsetForward);

//            while (true)
//            {
//                var adjustedItem = tongue.TransformPoint(tonguePosOffset);
...
//         *         anal - vec.down
//         */
//        private readonly Dictionary<HandCtrl.AibuColliderKind, LickItem> PoI = new()
//        {
